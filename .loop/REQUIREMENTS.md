...
| Retrieval | Retrieval debugger in Web | PARTIAL | Retrieval API exists; no dedicated Web route/page. |
...
| Quality | Retrieval, answer, and tool evaluations | MISSING | Need stable corpora, metrics, and runner/report. |
...
| Interfaces | Retrieval/Capabilities/Evaluation/Traces UI | MISSING | Not present as independent navigation pages. |
